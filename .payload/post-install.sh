...
update_dns_config() {
	...
	try set service dns forwarding blacklist domains source OISD url 'https://dblw.oisd.nl/light/'
	try set service dns forwarding blacklist domains source OISD prefix '*.'
