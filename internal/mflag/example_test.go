...
// String is the method to format the flag's value, part of the mflag.Value interface.
// The String method's output will be used in diagnostics.
func (i *interval) String() string {
	return fmt.Sprint(*i)
}

// Set is the method to set the flag value, part of the mflag.Value interface.
