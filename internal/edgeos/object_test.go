...
var (
	filesNone = sort.StringSlice{"includes", "includes", "malc0de", "malwaredomains.com", "openphish", "raw.github.com", "simple_tracking", "sysctl.org", "volkerschatz", "yoyo", "zeus"}
	filesOnly = sort.StringSlice{"tasty"}
	urlsNone  = sort.StringSlice{"includes", "includes", "tasty"}
