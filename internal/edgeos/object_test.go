...
var (
	filesNone = sort.StringSlice{"includes.[1]", "includes.[9]", "malc0de", "malwaredomains.com", "openphish", "raw.github.com", "simple_tracking", "sysctl.org", "volkerschatz", "yoyo", "zeus"}
	filesOnly = sort.StringSlice{"tasty"}
	urlsNone  = sort.StringSlice{"includes.[1]", "includes.[9]", "tasty"}
